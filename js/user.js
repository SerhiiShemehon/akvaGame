...
function ready() {
    ...
    function goPlayerOne() {
        playerOne.style.cssText = "transition: run 60s ease-in;-webkit-animation: run 60s linear;-moz-animation: run 60s linear;-ms-animation: run 60s linear;-o-animation: run 60s linear;"
    }
    //task
    var rand1;
    var rand2;
